...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<button align="right" type="button" onclick="expressType('month')" style="float: center;">월 조회</button>&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<button align="right" type="button" onclick="expressType('year')" style="float: center;">년도 조회</button>&nbsp;
