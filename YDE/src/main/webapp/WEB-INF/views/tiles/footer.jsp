...
<body>
	...
	<div style="width: 100%; text-align: left;">
		<font color="#bbb" size="2px">(주)YDExpress 대구광역시 중구 국채보상로 537(수동, 5층)
			(상동, 드라마씨티) Tel: ☎ 이사문의: 1800-2450 / ☎ 청소문의: 1833-7856FAX:
			02-6499-2678<br /> E-Mail: karam21c@nate.com개인정보보호책임자: 정일권<br />
