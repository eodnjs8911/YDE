...
<script type='text/javascript'>
	...
	function detailSave() {
		...
		$.getJSON('/yde/express/expressDetailSave.do', formData,
				function(data) {
	...
	function detailIns() {
		var formData = $("#expressDetailForm").serialize();
		$.getJSON('/yde/express/expressDetailIns.do', formData, function(data) {
			if (data.result == "success") {
				$("#expressDetailModal").modal('hide')
	...
	function detailDel() {
		var formData = $("#expressDetailForm").serialize();
		$.getJSON('/yde/express/expressDetailDel.do', formData, function(data) {
			if (data.result == "success") {
				$("#expressDetailModal").modal('hide')
			...
			<div class="modal-body">
				<div class="container-fluid">
					...
					<form class="form-horizontal" id="expressDetailForm">
						...
						<div class="form-group">
							<label for="expressDepartureAddr2" class="col-md-3 control-label">상세주소</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							...
							<label for="expressEstimateAmount" class="col-md-2 control-label">견적금액</label>
							<div class="col-md-4">
