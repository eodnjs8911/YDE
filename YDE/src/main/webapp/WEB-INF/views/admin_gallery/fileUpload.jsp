...
<%
	...
	String up_dir = ( request.getParameter("up_dir") != null ) ? request.getParameter("up_dir") :"/resources/images"; 
	
	// 임시 업로드 폴더
	String temp_dir = ( request.getParameter("temp_dir") != null ) ? request.getParameter("temp_dir") : "c:/Temp"; 
