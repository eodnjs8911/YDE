...
import com.yedam.yde.employee.EmployeeDAO;
import com.yedam.yde.resource.ResourceDAO;
...
public class ExpressServiceImpl implements ExpressService {
	...
	public int consultReg(ExpressVO vo) {
		...
		if (vo.getExpressNo() != null && vo.getExpressNo() > 0) {
			...
			consultString += "출발지 : " + vo.getExpressDepartureAddr1() + " / " + vo.getExpressDepartureSize() + "평  / "
					+ vo.getExpressDepartureFloor() + "층\n";
			consultString += "도착지 : " + vo.getExpressArriveAddr1() + " / " + vo.getExpressArriveSize() + "평  / "
					+ vo.getExpressArriveFloor() + "층\n";
			consultString += "특수이삿짐 : " + vo.getExpressSpeicialItem() + " / " + "예상견적 : "
					+ vo.getExpressEstimateAmount();
